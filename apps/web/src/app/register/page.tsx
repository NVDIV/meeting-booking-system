    ...
    <div className="mx-auto max-w-md px-4 py-16">
      <div className={`${ui.card} ${ui.cardPad} border-t-2 border-t-cyan-500`}>
        ...
        <p className="mt-1 text-xs text-slate-400 text-center font-mono">
          Створення нового облікового запису оператора
        </p>
        ...
        <form className="mt-6 space-y-4 font-mono text-xs" onSubmit={handleRegister}>
          <div>
            ...
            <input 
              ...
              placeholder="Олександр Степанов" 
          ...
          <div className="pt-2">
            <button type="submit" disabled={loading} className={`${ui.btnPrimary} w-full py-2.5 text-center`}>
              {loading ? "CREATING..." : "CREATE_ACCOUNT_INIT _"}
            </button>
          </div>
        </form>
        ...
        <div className="mt-5 pt-4 border-t border-slate-900 text-center font-mono text-[11px] text-slate-500">
          Вже зареєстровані?{" "}
          <Link href="/login" className="text-cyan-400 hover:text-cyan-300 underline underline-offset-4 transition-colors">
            SIGN_IN_TERMINAL &gt;&gt;
          </Link>
        </div>
